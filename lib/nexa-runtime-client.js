...
(function () {
    ...
    function applyNodeBox(el, comp, parentNode) {
        var M = window.NexaModel;
        var css = M ? M.boxCss(comp, parentNode) : { position: "absolute", left: (comp.x || 0) + "px", top: (comp.y || 0) + "px", width: comp.w + "px", height: comp.h + "px" };
    ...
    function mountTemplateVisual(parentEl, comp, inheritedVis, templates, namespace, visitedTemplateIds, screenForCtx, paramState) {
        ...
        applyNodeBox(el, comp, parentEl.__nexaNode || null);

...
function applyMetrics(target, metrics, timestamp, aliasToName) {
  ...
  (metrics || []).forEach(function (m) {
    ...
    var type = m.type || prev.type;
    var properties = m.properties !== undefined && m.properties !== null ? m.properties : prev.properties;
    var metadata = m.metadata !== undefined && m.metadata !== null ? m.metadata : prev.metadata;
    var engUnit = m.engUnit !== undefined && m.engUnit !== null ? m.engUnit : prev.engUnit;
    var isHistorical = m.isHistorical !== undefined ? m.isHistorical : prev.isHistorical;
    var isTransient = m.isTransient !== undefined ? m.isTransient : prev.isTransient;
